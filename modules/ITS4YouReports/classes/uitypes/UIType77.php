...
class UIType77 extends UITypes {
    protected $id_cols_array = array("inventorymanager", "smownerid", "user_name");
    protected $relModuleName = 'Users';
    protected $oth_as = '_77';
...
//show("<font color='green'>fielduitype77_IN_P_".$field_uitype,$related_join_array,$params["using_array"],"</font>");
