...
class UIType78 extends UITypes {
    protected $relModuleName = 'Quotes';
    protected $oth_as = '_78';
    ...
    public function getStJoinSQL(&$join_array, &$columns_array) {
        if (isset($this->params["fieldid"]) && $this->params["fieldid"] != "") {
            ...
            if (!array_key_exists(" vtiger_crmentity AS vtiger_crmentity".$this->oth_as . $fieldid_alias . " ", $join_array)) {
                ...
                $join_array[" vtiger_crmentity AS vtiger_crmentity".$this->oth_as . $fieldid_alias . " "]["using"] = "vtiger_quotes" . $fieldid_alias . ".quoteid ";
            }
        }
    }
    ...
    public function getJoinSQL(&$join_array, &$columns_array) {
        ...
        if ($this->params["columnname"] == "quoteid") {
            $this->params["join_tablename_alias"] = "vtiger_quotes" . $fieldid_alias;
