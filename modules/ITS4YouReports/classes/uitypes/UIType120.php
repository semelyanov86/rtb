...
class UIType120 extends UITypes {
    ...
    public function getJoinSQL(&$join_array, &$columns_array) {
        ...
        */
        $columns_array_value = $tablename . "." .$this->params["columnname"];
        $fld_alias = $this->params["columnname"];
        $fld_cond = $tablename . "." .$this->params["columnname"];
...
//show("<font color='green'>fielduitypeJOJO120",$join_array,$this->params["field_uitype"],$columns_array,"</font>");		
    }
...
//show("<font color='green'>fielduitype120_IN_P_".$field_uitype,$related_join_array,$params["using_array"],"</font>");
