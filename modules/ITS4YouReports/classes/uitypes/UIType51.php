...
class UIType51 extends UITypes {
    protected $id_cols_array = array("accountid", "account_id", "parentid");
    protected $relModuleName = 'Accounts';
    protected $oth_as = '_51';
...
//show("<font color='green'>fielduitype51_IN_P_".$field_uitype,$related_join_array,$params["using_array"],"</font>");
