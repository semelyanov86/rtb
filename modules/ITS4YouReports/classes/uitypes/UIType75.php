...
class UIType75 extends UITypes {
    protected $id_cols_array = array("vendorid", "vendor_id");
    protected $relModuleName = 'Vendors';
    protected $oth_as = '_75';
    ...
    public function getStJoinSQL(&$join_array, &$columns_array) {
        if (isset($this->params["fieldid"]) && $this->params["fieldid"] != "") {
            ...
            if (!array_key_exists(" vtiger_vendor AS vtiger_vendor" . $fieldid_alias . " ", $join_array)) {
                ...
                $join_array[" vtiger_vendor AS vtiger_vendor" . $fieldid_alias . " "]["using"] = $tablename . $old_oth_fieldid . $mif_as . "." . $columnname;
            }
...
//show("<font color='green'>fielduitype75_IN_P_".$field_uitype,$related_join_array,$params["using_array"],"</font>");
