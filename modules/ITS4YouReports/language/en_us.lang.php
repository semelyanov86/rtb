...
/*+********************************************************************************
 * The content of this file is subject to the Reports 4You license.
...
"ITS4YouReports"=>"Reports 4You",	
"LBL_MODULE_NAME"=>"Reports 4You",
'MyExtension' => 'My Extension',
"LBL_TEMPLATE_GENERATOR"=>"Reports 4You",
"LBL_DELETE"=>"Delete",
...
"LBL_FINISH"=>"Finish",
"LBL_NEXT"=>"Next",
"LBL_INSTRUCTIONS"=>"Follow these instructions in order to install Reports 4You.",
"LBL_FILE"=>"file",
...
"LBL_INSTAL_ERROR"=>"Error occured during installation of Reports 4You.",
...
"LBL_INVALID_KEY"=>"Invalid license key! Please contact the vendor of Reports 4You.",
...
"LBL_DOWNLOAD_SRC_DESC" => 'Click on Download button to download <strong><a href="http://www.highcharts.com/" target="_blank">HighCharts</a></strong> package OEM License ID: 100028434001400 and unzip it into <pre>~VTIGER_ROOT/modules/ITS4YouReports/highcharts/ to complete Installation.</pre>',
...
"LBL_WELCOME"=>"Welcome to the Reports 4You Installation Wizard",
"LBL_WELCOME_DESC"=>"This will install Reports 4You into your vtiger CRM.",
"LBL_WELCOME_FINISH"=>"It is highly recommended to finish the installation without any interruption.",
"LBL_TRY_AGAIN"=>"Try Again",
"LBL_MB_STRING_ERROR"=>"mPdf script requires <strong>mb_string</strong> extension to be enabled in your PHP installation. Please enable this extension for correct working of Reports 4You.",

"LBL_PROFILES_DESC"=>"Manage user-specific Reports 4You access to different Roles.",
"LBL_SETPRIVILEGIES"=>"Define Reports 4You privilegies for all profiles",
...
"LBL_INSTALL_SUCCESS"=>"Reports 4You has been installed successfully.",
...
'LBL_STEP1_INFO' => 'In Step 1, you will have to provide basic Report informations:<br />
...
',
'LBL_STEP5_INFO' => '
In Step 3, you can select the fields to display in report with details.<br />
...
'LBL_STEP6_INFO' => 'In Step 4, you can select the calculations for the fields available across the Report modules. <br />
You can select the calculations like SUM, AVG, MIN and MAX values across the Report result records.',
'LBL_STEP7_INFO' => 'Step 5 gives you the flexibility to customize selected field labels.',
'LBL_STEP8_INFO' => '
In Step 6, you can specify the conditions to filter the results in a report.<br /> 
...
'LBL_STEP9_INFO' => '
In Step 7, you can specify the security of the report. Here you can select report Owner and the type of report Sharing Rules(Public, Private or Share) across users in role hierarchy.<br />
...
*/
'LBL_STEP10_INFO' => '
In Step 8, you can Send Reports at regular intervals to specific users through email without logging in to the CRM.<br />
...
'LBL_STEP11_INFO' => '',
'LBL_STEP12_INFO' => '
In Step 9, you can define Charts for every Report that is having a "Group by" definition and "Summaries columns".<br />
Data series is using Summaries columns values so you can define which one you want to used in charts.<br />
Additionally you can define Chart title which is used in output files.',
...
"Please_Install_PDFMaker" => 'Please install PDF Maker extension for Exporting Reports to PDF.<br> Visit <a href="http://www.its4you.sk/en/vtiger-shop.html?record=812" target="_blank">IT-Solutions 4You s.r.o.</a> website to purchase PDF Maker extension <br> or <a href="http://forge.vtiger.com/frs/?group_id=334&release_id=941" target="_blank">vtiger forge</a> to download free version.',
...
"REACTIVATE_SUCCESS"=>"You have successfuly reactivated your Reports 4You.",
...
"LBL_FILE_NOT_SUPPORTED" => "Not supported file for Reports 4You Import",
"LBL_DOTS" => "...",
"LBL_DONE" => "Done",
