...
/**
 * Class Stats_Uninstall_View
 */
class Stats_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_statscf table
        echo "&nbsp;&nbsp;- Delete vtiger_statscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_statscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_stats table
        echo "&nbsp;&nbsp;- Delete vtiger_stats table.";
        $result = $adb->pquery("DROP TABLE vtiger_stats");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
