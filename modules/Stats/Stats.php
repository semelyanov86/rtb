...
class Stats extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_stats';
	var $table_index= 'statsid';
	var $related_tables = Array ('vtiger_statscf' => Array ( 'statsid', 'vtiger_stats', 'statsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_statscf', 'statsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_stats', 'vtiger_statscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_stats' => 'statsid',
		'vtiger_statscf'=>'statsid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_stats, vtiger_users,
                ...
                vtiger_stats.statsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_stats.statsid = $id AND
