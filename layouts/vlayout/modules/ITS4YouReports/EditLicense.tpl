	...
	<div class="CustomLabelModalContainer">
		<div class="modal-header">
			...
			{if $TYPE eq "reactivate"}
				<h3>{vtranslate('LBL_REACTIVATE', 'ITS4YouReports')}</h3>
			{else}
				<h3>{vtranslate('LBL_ACTIVATE_KEY', 'ITS4YouReports')}</h3>
			{/if}
		</div>
		<form id="editLicense" class="form-horizontal contentsBackground">
				...
				<div class="row-fluid">
					<div class="control-group">
						<label class="muted control-label">{vtranslate('LBL_LICENSE_KEY', 'ITS4YouReports')}</label>
