                    ...
                    <tr>
                        ...
                        <td style="border-left: none;">
                            <div class="pull-left" style="float:left;">
                                <select name="maps_api_use_type" id="maps_api_use_type" class="span3 chzn-select row">
                            ...
                            <div class="pull-left maps_api_keys" style="float:left;">
                            &nbsp;&nbsp;
                                {if $IS_ADMIN_USER}
                                    <input name="maps_api_key_default" id="maps_api_key_default" autocomplete="off" class="span8 maps_api_keys input-large {if 'default' neq $MAPS_API_USE_TYPE}hide{/if}" value="{$DEFAULT_MAPS_API_KEY}"
                                           placeholder="{vtranslate('LBL_DEFAULT_KEY_PLACEHOLDER', $MODULE)}">
                                {/if}
                                <input name="maps_api_key_user" id="maps_api_key_user" autocomplete="off" class="span8 maps_api_keys input-large {if 'user' neq $MAPS_API_USE_TYPE}hide{/if}" value="{$MAPS_API_KEY}"
