 ...
 ********************************************************************************/
-->*}
	<a name="ddetail" class="icon-th-list" data-url="{$WIDGET->getDeleteUrl()}" onclick='window.location.href = "{$detailViewUrl}"' >
		<i class="icon-remove" hspace="2" border="0" align="absmiddle" title="{vtranslate('LBL_VIEW_DETAILS', $MODULE_NAME)}" alt="{vtranslate('LBL_VIEW_DETAILS', $MODULE_NAME)}"></i>
	</a>
{if $SETTING_EXIST}
<a name="dfilter">
