...
Vtiger_List_Js("ITS4YouReports_KeyMetricsList_Js", {
    ...
    registerEditRecordClickEvent: function(){
        ...
        listViewContentDiv.on('click','.editRecordButton',function(e){
            ...
            ITS4YouReports_KeyMetricsList_Js.triggerAddKeyWidget('index.php?module=ITS4YouReports&view=EditKeyMetrics&id='+recordId);
            e.stopPropagation();
        });
    },
            ...
            submitHandler : function(form) {
                ...
                app.request.get(params).then(
                    function (error, data) {
                        ...
                        app.hideModalWindow();
                        if (true === res_status) {
                            window.location.href = 'index.php?module=ITS4YouReports&view=KeyMetricsRows&id=' + km_id;
                            return true;
                        } else {
                            var params = {
    ...
    registedAddNewWidget : function(){
        ...
        add_widget_href.on('click', function(e) {
            ITS4YouReports_KeyMetricsList_Js.triggerAddKeyWidget('index.php?module=ITS4YouReports&view=EditKeyMetrics');
        });
    ...
    registerReportChangeEvent : function(){
        ...
        reportNameElement.on('change', function(e) {
            ...
            var url = 'index.php?module=ITS4YouReports&action=IndexAjax&mode=getKeyMetricReportColumns&reportid='+reportid;
...
jQuery( document ).ready(function() {
	...
	if('KeyMetricsRows'===view || 'EditKeyMetricsRow'===view) {
		Vtiger_Index_Js.getInstance().registerAppTriggerEvent();
	}
});