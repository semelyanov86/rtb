                                ...
                                <td class="listViewEntryValue" data-name="{$LISTVIEW_HEADERNAME}" title="{$LISTVIEW_ENTRY_RAWVALUE}" data-rawvalue="{$LISTVIEW_ENTRY_RAWVALUE}" data-field-type="">
										<span class="fieldValue">
											<span class="value textOverflowEllipsis">
												{if $COLUMNNAME=="name"}
                                                    <a href="index.php?module={$MODULE}&view=KeyMetricsRows&id={$LISTVIEW_ENTRY.id}">
                                                        {$COLUMNVALUE}
                                                    </a>
                            ...
                            <td colspan="{$COLSPAN_WIDTH}">
                                <div class="emptyRecordsDiv">
                                    <div class="emptyRecordsContent">
                                        ...
                                        {vtranslate('LBL_NO')} {vtranslate('LBL_KEY_METRICS', $MODULE)} {vtranslate('LBL_FOUND')}. <a href="javascript:void(0);" id="add_widget_href" style="color:blue">{vtranslate("LBL_ADD_ITEM", $MODULE)} {vtranslate("LBL_KEY_METRICS", $MODULE)}</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
