...
{strip}
    <form class="form-horizontal recordEditView padding1per" id="form_report_types" method="post" action="index.php">
            ...
            {assign var="selected_bg_color" value="#f9f9f9"}
            {assign var="selected_bg_name" value="background-color"}
            {assign var="selected_bg_style" value="{$selected_bg_name}:$selected_bg_color;"}
            <input type="hidden" id="selected_bg_color" value="{$selected_bg_color}" >
            <input type="hidden" id="selected_bg_name" value="{$selected_bg_name}" >
            <div class="padding1per border1px">
                    <div class="row-fluid">
                            <div>
                                    ...
                                    <div>
                                        <div>
                                                <ul class="nav nav-tabs" name="reportypetab" id="reportypetab"  style="text-align:center;font-size:14px;font-weight: bold;margin:0 3%;border-bottom:0px">
                                                        <li class="active marginRight5px" >
                                                                <a id="tabular" data-toggle="tab" style="{$selected_bg_style}">
                                                ...
                                                <div class='tab-content contentsBackground' id="reportypeInfoTab" style="height:auto;padding:4%;border:1px solid #ccc; background-color: {$selected_bg_color};">
                                                        <div>
