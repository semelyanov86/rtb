...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		{assign var=STATS_MODULE_MODEL value=Vtiger_Module_Model::getInstance('Stats')}
		<div class="app-list row">
			...
			{/if}
                        {if $USER_PRIVILEGES_MODEL->hasModulePermission($STATS_MODULE_MODEL->getId())}
                                <div class="menu-item app-item dropdown-toggle" data-default-url="{$STATS_MODULE_MODEL->getDefaultUrl()}">
                                        <div class="menu-items-wrapper">
                                                <span class="module-icon">{$STATS_MODULE_MODEL->getModuleIcon()}</span>
                                                <span class="app-name textOverflowEllipsis"> {vtranslate('Statistics',$MODULE)}</span>
                                        </div>
                                </div>
                        {/if}
